...
namespace Level
{
	glm::vec3 Room(bool up, bool down, bool right, bool left, std::string texture, int rotation, int entrensSide)
	{
		...
		if (up && entrensSide == 1)
		{
			toReturn = glm::vec3(0.50f, 0.0f, -82.60f) + glm::vec3(0.00f, 0.00f, 12.80f);
		}
		else if (down && entrensSide == 0)
		{
			toReturn = glm::vec3(-2.90f, 0.00f, 95.80f) - glm::vec3(0.00f, 0.00f, 10.50f);
		}
		else if (right && entrensSide == 3)
		{
			toReturn = glm::vec3(-91.90f, 0.00f, 5.00f) + glm::vec3(12.40f, 0.00f, 0.00f);
		}
		else if (left && entrensSide == 2)
		{
			toReturn = glm::vec3(100.00f, 0.00f, 5.70f) - glm::vec3(15.00f, 0.00f, 0.00f);
		}
		else
		{
