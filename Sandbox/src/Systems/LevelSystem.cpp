...
namespace MCS
{
	...
	void LevelSystem::OnUpdate()
	{
		if (m_Start)
		{
			...
			m_LevelFileFormat.OpenFromFile("deadend_chests_IsStatick_t_p_e_r", m_PlayerPos, playerTransform, rotate);
			m_Start = false;
			m_LevelFileFormat.LoadBoolMap("deadend_chests_IsStatick_t_p_e_r");
		}
	}
