...
namespace MCS
{
	...
	void ParticleSystem::Render()
	{
		for (size_t i = 1; i < p_Total; i++)
		{
			...
			Frosty::Renderer::SubmitParticles(m_ParticleSystem[i]->UseShader, m_ParticleSystem[i]->ComputeShader, m_ParticleSystem[i]->ParticleVertArray, transform, m_ParticleSystem[i]->ParticleCount, 2.0f);
